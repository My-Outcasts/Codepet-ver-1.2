...
const NAV: Array<{ view: View; label: string; icon: React.ReactNode; count?: () => number }> = [
  { view: 'overview', label: 'Overview', icon: <svg className="ic" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="2.4" fill="currentColor" /><circle cx="4" cy="5" r="1.6" stroke="currentColor" strokeWidth="1.5" /><circle cx="16" cy="6" r="1.6" stroke="currentColor" strokeWidth="1.5" /><circle cx="5" cy="15" r="1.6" stroke="currentColor" strokeWidth="1.5" /><circle cx="15" cy="15" r="1.6" stroke="currentColor" strokeWidth="1.5" /><path d="M8.4 8.7 5.2 6.1M11.6 8.7 14.6 6.6M8.6 11.3 6 13.9M11.4 11.3 14 13.9" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /></svg> },
